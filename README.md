...
- [choro-scrape](https://github.com/fabianmoss/choro-scrape): scraping the contents of the Casa do Choro archive
- [choro-model](https://github.com/fabianmoss/choro-model): chord model
- [choro-audio](https://github.com/fabianmoss/choro-audio): audio annotations
